                ...
                <div class="card-body">
                    ...
                    <form action=" <?= base_url()?>Mantenimiento/persona/agregar_personas" method="post" id="frm_agregar_persona">
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="md-form">
                                    ...
                                    <input type="text" style="color: red;" readonly value="" id="dis_codigo" class="form-control" name="dis_codigo"
                            ...
                            <div class="col-md-4 mb-4">
                                <select class="mdb-select" name="dis_pastor" aria-placeholder="Rol" id="dis_pastor" data-validetta="required">
                                    <option option value="">Seleccione pastor</option>
                                    <?php foreach ($datos_tipo_persona as $key => $value) {?>
                                    <option option value="<?=$value->per_id?>"><?=$value->per_username ?></option>
                                    <?php }?>
                                </select>
						...
						<div class="row d-flex justify-content-center">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="md-form">
                                    <input type="text" id="dis_nombre" class="form-control" name=""
                                        data-validetta="required,minLength[5]">
