...
<main>
    <div class="container-fluid mb-5">
        ...
        <section>
            <h2 class="text-center my-5 h1 pt-4">ZONA</h2>
            <div class="row">
                <div class="col-md-6 col-xl-5 mb-5">
                    <a type="button" href="<?= base_url() ?>Mantenimiento/Distrito/Agregar"
                        class="btn btn-deep-purple waves-effect waves-light">Agregar zona</a>
                </div>
                            ...
                            <table id="datatables" class="table table-striped table-bordered table-responsive-md"
                                ...
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <th style="font-weight: 900;"><?= $value->zon_codigo ?></th>
                                        <td><?= $value->zon_nombre ?></td>
                                        <td><?= $value->per_username ?></td>
                                        <td><?= $value->zon_fecha_creacion ?></td>
                                        <td><?= $value->zon_fecha_actualizacion ?></td>
...
<!-- Archivo js de index -->
<script src="<?php echo base_url("resources/js/Mantenimiento/Zona/Index_zona.js") ?>"></script>
